...
score$entailment_judgment=factor(score$entailment_judgment);
gold$entailment_judgment=factor(gold$entailment_judgment);
...
if (TRUE %in% is.na(score$entailment_judgment)){
	...
	}else if (FALSE %in% (levels(score$entailment_judgment) %in% levels(gold$entailment_judgment))){
